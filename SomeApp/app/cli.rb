class Cli
  ...
  def choose_country
      puts "What country are you insterested in?"
  ...
  def create_recommendation
    ...
    new_recommendation = Recommendation.create(attraction: recommended_attraction, traveler: @user.name, country: @new_country)
